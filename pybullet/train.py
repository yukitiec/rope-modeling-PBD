...
params_sim = {
    ...
    "turning_radius": 0.5,
    "turning_speed": 6.28, #2π
    "base_init": [0.0, 0.0, 1.0],
    "tip_init": [2.0, 0.0, 1.0],
    "rope_length": 2.0
}
...
_step_episode = _fps * params_sim["time_episode"]
...
trainer_instance = trainer.Trainer(
    ...
    fps=_fps,
    seed=0,
    turning_radius=params_sim["turning_radius"],
    turning_speed=params_sim["turning_speed"],
